...
class So100WCDataConfig(So100DataConfig):
    """
...
class So100W2CDataConfig(So100DataConfig):
    """
    phospho setup with one SO100 arm, a context cam and a wrist cam
    """
...
class DoubleSo100_1CamDataConfig(So100DataConfig):
    """
    phospho setup with 2 SO100 arm, and 1 camera
    """
...
class DoubleSo100DataConfig(BaseDataConfig):
    """
    phospho setup with 2 SO100 arm, and 2 wrist cams
    """
...
class DoubleSo100WCDataConfig(BaseDataConfig):
    """
    phospho setup with 2 SO100 arm, a context cam and 2 wrist cams
    """
...
class DoubleSo100W2CDataConfig(BaseDataConfig):
    """
...
DATA_CONFIG_MAP = {
    ...
    "so100_wc": So100WCDataConfig(),
    "so100_w2c": So100W2CDataConfig(),
    "double_so100_1cam": DoubleSo100_1CamDataConfig(),
    "double_so100": DoubleSo100DataConfig(),
    "double_so100_wc": DoubleSo100WCDataConfig(),
    "double_so100_w2c": DoubleSo100W2CDataConfig(),
}
